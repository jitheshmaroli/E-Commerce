...
const changePasswordView = async (req,res) => {
    try {
      ...
      res.render("auth/changePassword",{user,message:'' , categoryList});
    } catch (error) {
      console.log(error)
   ...
   const changePassword = async (req, res) => {
    ...
    try {
        ...
        if (!passwordMatch) {
            return res.render("auth/changePassword",{user, categoryList, message: 'Incorrect current password' });
        }
        ...
        return res.render("auth/changePassword",{user, categoryList, message: 'Password changed successfully' });
    } catch (error) {
